...
strings = ["I am very sad, I feel like killing myself","I don't know why to live anymore","I wanna die soon.",
                      "I am very very happy.","really excited"]

prediction = example(strings)
print(prediction)